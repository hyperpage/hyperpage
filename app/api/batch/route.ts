...
import { defaultBatchingMiddleware, isBatchRequest } from '../../../lib/api/batching/batching-middleware';
  ...
  try {
    ...
    if (!isBatchRequest(body.requests)) {
      return NextResponse.json({
        error: 'Invalid batch request format. Expected { requests: BatchRequest[] }',
