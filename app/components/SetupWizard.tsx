...
const initialTools: ToolConfig[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://support.atlassian.com/atlassian-account/docs/managing-api-tokens/'
  }
];
  ...
  const checkConfigurationStatus = async () => {
    try {
      ...
      setTools(prevTools => 
        prevTools.map(tool => ({
          ...tool,
          enabled: data.enabledTools?.includes(tool.name.toLowerCase()) || false,
        ...
        <div className="flex items-start gap-4 p-4 border rounded-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Edit <code className="bg-gray-100 px-1 rounded">.env.local</code> to enable your first tool (GitHub recommended)
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 p-4 border rounded-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Visit <a href="http://localhost:3000" className="text-blue-600 hover:underline">http://localhost:3000</a> to see your data!
            </p>
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                Make sure to configure at least one tool in your <code>.env.local</code> file first.
              </AlertDescription>
            </Alert>
          </div>
        </div>
    ...
    <Card className="w-full max-w-4xl">
      ...
      <CardContent className="space-y-6">
        ...
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            <strong>Pro tip:</strong> Start with GitHub for the quickest setup. Add other tools later once you see the portal working.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-5xl space-y-8">
        ...
        <div className="text-center text-sm text-muted-foreground pt-8 border-t">
          <p>Need help? Check the <a href="https://github.com/hyperpage/hyperpage" className="text-blue-600 hover:underline">documentation</a> or <a href="https://github.com/hyperpage/hyperpage/issues" className="text-blue-600 hover:underline">open an issue</a>.</p>
        </div>
      </div>
    </div>
  );
