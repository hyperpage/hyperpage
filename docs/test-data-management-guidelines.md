...
import { OAuthTestCredentials, IntegrationTestEnvironment } from '../../lib/test-credentials';
...
const mockJiraIssue = {
  ...
  description: "As a user, I want to authenticate using OAuth so that I can securely access the application.",
  status: {
    name: "Open",
    id: "10001",
    category: "new"
