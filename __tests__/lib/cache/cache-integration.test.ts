  ...
  describe('Environment-based Cache Selection', () => {
    ...
    it('should create hybrid cache when Redis URL is set', async () => {
      ...
      try {
        ...
        try {
          await envCache.set('hybrid-test', { type: 'hybrid', fallback: true }, 60000);
          ...
          // The cache system is designed to fail gracefully in this.Append
          console.log('Expected Redis operation failure in test environment:', (error as Error).message);
