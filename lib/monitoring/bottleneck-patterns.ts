...
export const BOTTLENECK_PATTERNS: BottleneckPattern[] = [
  {
    ...
    description:
      "Rising memory usage with degrading response times and increasing GC activity",
    severity: "critical",
    ...
    conditions: [
      ...
      {
        metric: "batching.averageBatchDuration",
        operator: "gt",
        threshold: 3000,
        duration: 300000,
        weight: 25,
    ...
    recommendations: [
      {
        ...
        category: "immediate",
        action:
          "Investigate memory usage patterns and consider container restart",
...

  {
    ...
    description:
      "Low cache hit rate causing high database load and increased response times",
    severity: "warning",
    category: "performance",
    ...
    recommendations: [
      {
        ...
        action:
          "Increase cache memory allocation and review cache key strategy",
...

  {
    ...
    description:
      "Platform rate limits causing throttling, errors, and degraded performance",
    severity: "critical",
    ...
    conditions: [
      ...
      {
        metric: "batching.batchSuccessRate",
        operator: "lt",
        threshold: 95,
        duration: 300000,
        weight: 35,
    ...
    recommendations: [
      {
        ...
        category: "immediate",
        action:
          "Reduce request frequency by 30% and enable exponential backoff",
      ...
      },
      {
        ...
        category: "configuration",
        action:
          "Request platform rate limit increase or implement load distribution",
...

  {
    ...
    description:
      "Connection pool exhausted causing request queuing and timeouts",
    severity: "critical",
    category: "capacity",
...

  {
    ...
    description:
      "Poor compression ratios causing high bandwidth usage and slower responses",
    severity: "info",
    category: "efficiency",

    conditions: [
      {
        metric: "compression.averageCompressionRatio",
        operator: "lt",
        threshold: 40,
        duration: 300000,
        weight: 50,
      ...
      {
        metric: "compression.compressionSavingsBytes",
        operator: "lt",
        threshold: 50000,
        duration: 300000,
        weight: 20,
    ...
    correlatedIndicators: [
      "overall.averageResponseTime",
      "compression.compressionSavingsBytes",
    ],
...

  {
    ...
    description:
      "Batch operations overwhelmed causing high latency and individual failures",
    severity: "warning",
    category: "performance",
    ...
    conditions: [
      ...
      {
        metric: "batching.averageBatchSize",
        operator: "gt",
        threshold: 15,
        duration: 300000,
        weight: 25,
...

  {
    ...
    description:
      "Circuit breaker activated, indicating persistent service issues",
    severity: "critical",
    category: "reliability",
    ...
    recommendations: [
      {
        ...
        category: "immediate",
        action:
          "Investigate upstream service availability and implement failover",
...

  {
    ...
    description:
      "System throughput approaching capacity limits requiring scaling",
    severity: "warning",
    category: "capacity",
    ...
    recommendations: [
      ...
      },
      {
        ...
        category: "configuration",
        action:
          "Enable request queuing and load shedding for non-critical requests",
...

  {
    ...
    description:
      "Consistently slow operations indicating underlying performance issues",
    severity: "warning",
    category: "performance",
 ...
 */
export function getBottleneckPattern(
  id: string,
): BottleneckPattern | undefined {
...
export function getQuickDetectionPatterns(): BottleneckPattern[] {
  return BOTTLENECK_PATTERNS.filter(
    (pattern) =>
      pattern.minimumConfidence >= 80 && pattern.category !== "efficiency", // Skip efficiency issues for quick detection
  );
}
